...
catalog = Catalog(
	...
	description = "Go and see symbolic historical spots and natural spectacles.")
session.add(catalog)
session.commit()
...
catalog = Catalog(
	name = "Food & Drink", 
	description = "Indulging in local food and drink is a must-do for many travellers.")
session.add(catalog)
session.commit()
...
catalog = Catalog(
	name = "Shopping", 
	description = "Go shopping in and immerse yourself in bustling markets, artisan foods, designer labels and gifts infused with cultural uniqueness and beauty.")
session.add(catalog)
session.commit()
...
catalog = Catalog(
	name = "Activity", 
	description = "Consider some of these other fun-filled activities.")
session.add(catalog)
session.commit()
...
catalog = Catalog(
	name = "Arts", 
	description = "For a totally unique experience, immerse yourself in the local arts.")
session.add(catalog)
session.commit()
